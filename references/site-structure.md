...
- **Story** — two or three short paragraphs in the brand's voice: where it sits (quartier + street — "Au cœur de la Jonction", "boulevard Carl-Vogt"), who's behind it (the named owner or family, with a since-year where there is one), what it makes and how ("fait maison", "au feu de bois", "à la main"), and the feel of the place — the room, the materials, the welcome. A signature figure or rating is often woven into the closing line. Keep it specific to the dossier — no generic "passion & quality" filler.
- **Facts / highlights strip** — a compact sub-block pinning the story to concrete proof, in one of three recurring shapes: a **checklist of feature chips**, each with a line-art glyph ("100 % bio & local", "Bifanas maison", "Un seul animal à la fois"); a **stat block** of big-number + label pairs ("1994 · une institution depuis", "100+ thés de Chine", "4,2/5 · 85 avis Google"); or a **definition list of facts** ("Depuis — 2019", "Quartier — Plainpalais", "Service — sur place · à emporter · livraison"). This is where the since-year, quartier, service modes and **ratings** surface as trust signals. No price list here, though the strip may carry a light price posture where it's part of the identity ("Coupe dès 20.–", "1–10 CHF").
...
- **Certifications & trust signals** — trade-specific and **sparing**, only when real: a professional membership or label ("Membre de l'ABCGE", the "Artisan·e Métiers d'Art Genève" label), sometimes given its own small **seal band** with an emblem and a fact or two. Otherwise the **ratings and figures** in the facts strip carry the proof (Google / TripAdvisor scores, review counts, a "Travelers' Choice" mention or a ranking). Never fabricate a credential — omit the sub-component when the dossier has none.
